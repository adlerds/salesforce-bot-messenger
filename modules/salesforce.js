...
let findAccount = name => {
    return new Promise((resolve, reject) => {
        ...
        //let q = "SELECT Id, Name, PersonTitle, PersonEmail FROM Account WHERE Name LIKE '%" + name + "%' LIMIT 5";
       let q = "SELECT Id, Side_Effect_Summary__C, Side_Effect_Details__c, Side_effect_Image__c, Side_Effect_URL__c, Related_Product__c FROM Side_Effects__c WHERE Related_Product__c = '01t1100000651BWAAY' LIMIT 5";
